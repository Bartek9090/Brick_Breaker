...
# create a class with component and their function
class PlayComponent(object): # why here we have a object. Which basically is a object in this class
...
# create a class give opportunities to update object from class Play_game
class Paddle(PlayComponent):
    def __init__(self, canvas, x, y):
        ...
        item = canvas.create_rectangle(x - self.width/2,
                                       ...
                                       y + self.height/2,
                                       fill='green')
        super(Paddle, self).__init__(canvas, item) # what means super here. Working as a recursive function?
...
class Brick(PlayComponent):
    ...
    color_array = {1: 'magenta', 2: 'royalblue', 3: 'blue'}

    def __init__(self, canvas, x, y, hits):
        self.width = 60
        self.height = 20
        self.hits = hits
        color = Brick.color_array[hits]
        item = canvas.create_rectangle(x - self.width/2,
                                       y - self.height/2,
                                       x + self.width/2,
                                       y + self.height/2,
    ...
    def hit(self):
        ...
        if self.hits == 0:
            ...
            self.canvas.itemconfig(self.item, fill=Brick.color_array[self.hits])
